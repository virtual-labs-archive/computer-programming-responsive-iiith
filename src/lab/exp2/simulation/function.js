window.view = {
  ...
  validateRectangleInputs: function () {
    ...
    if (a !== "2")
      alert(
        "Incorrect value of input variables(arguments). Calculating the area of a right angle requires base and height of triangle. Try again."
      );
    else if (b !== "float")
      alert(
  ...
  displayFunctionForRectangle: function () {
    document.getElementById("functionRectangle").innerHTML +=
      "float area_righttriangle (float a,float b)<br>{<br> &emsp; float area = (1/2)*a*b;<br> &emsp; return area;<br>}";
  },
