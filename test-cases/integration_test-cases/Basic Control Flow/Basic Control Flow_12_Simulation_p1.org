...
* Test Steps
  ...
  4. Enter values in X field and don't enter values in Y field and vice-versa
...
* Expected result
  ...
  4. An error message should be displayed on the screen as to enter they vlaue and vice-versa
